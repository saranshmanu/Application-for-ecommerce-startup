...
//  Startup
//
//  Created by Saransh Mittal on 24/08/17.
...
class ImageEditorViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        imageView.image = selectedImageForEditing
    }
    
    @IBAction func reset(_ sender: Any) {
        photos.remove(at: selectedImageNumber)
        photos.insert(imageView.image!, at: selectedImageNumber)
